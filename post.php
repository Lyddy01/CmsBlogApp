<?php  include "includes/db.php"; ?>
 ...
 ?>
    ...
    if(isset($_SESSION['username']) && is_admin($_SESSION['username']) ) {
        ...
        $stmt = mysqli_query($connection, "SELECT post_title, post_author, post_date, post_image, post_content FROM posts WHERE post_id = '$the_post_id'");

    } else {
        $stmt = mysqli_query($connection , "SELECT post_title, post_author, post_date, post_image, post_content FROM posts WHERE post_id = '$the_post_id' AND post_status = 'published' ");
    ...
    while($row = mysqli_fetch_assoc($stmt)) {
        ...
        ?>
          ...
          <h1 class="page-header">
                ...
                <hr>
                <img class="img-responsive" src="/cmsd/images/<?php echo $row['post_image'];?>" alt="">
                <hr>
...
<?php include "includes/footer.php";?>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.like').click(function(){
                    $.ajax({
                        url: "/cmsd/post.php?p_id=<?php echo $the_post_id; ?>",
                        type: 'post',
                        data: {
                            'liked': 1,
                            'post_id': post_id,
